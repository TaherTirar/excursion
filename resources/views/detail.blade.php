                            ...
                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-home" aria-selected="true"><i class="flaticon-info"></i>
                                        Information</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <ul class="table-list-disallow">
                                                                        <li> <i class="bx bx-x"></i> Additional Services
                                                                        </li>
                                                ...
                                                <ul class="p-timeline">
                                                    <li>
                                                        ...
                                                        <div class="timeline-content">
                                                            ...
                                                            <p>Pellentesque accumsan magna in augue sagittis, non fringilla
                                                                eros molestie. Sed feugiat mi nec ex vehicula, nec
                                                                vestibulum orci semper. Class aptent taciti sociosqu ad
                                                                litora torquent per conubia nostra, per inceptos himenaeos.
                                                                Donec tristique commodo fringilla.</p>
                                                            <ul>
                                                                <li>
                                                                <li><i class="bx bx-check"></i>Specilaized Bilingual Guide
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                <li><i class="bx bx-check"></i>Box Lunch,Water,Dinner and
                                                                    Snacks</li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                ...
                                                <div class="package-grid-one">
                                                    <div class="single-grid">
                                                        <a class="g-img-sm-1 main-gallary"
                                                            href="{{ asset('assets/images/gallary/gl-1.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/gl-1.png') }}" alt>
                                                        </a>
                                                        <a class="g-img-sm-2 main-gallary"
                                                            href="{{ asset('assets/images/gallary/gl-2.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/gl-2.png') }}" alt>
                                                        </a>
                                                        <a class="g-img-md main-gallary"
                                                            href="{{ asset('assets/images/gallary/g-xxl-1.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/g-xxl-1.png') }}"
                                                                alt>
                                                        </a>
                                                    </div>
                                                    <div class="single-grid mt-24">
                                                        ...
                                                        <a class="g-img-sm-2 main-gallary"
                                                            href="{{ asset('assets/images/gallary/gl-4.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/gl-4.png') }}" alt>
                                                        </a>
                                                        <a class="g-img-md main-gallary"
                                                            href="{{ asset('assets/images/gallary/g-xxl-2.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/g-xxl-2.png') }}"
                                                                alt>
                                                        </a>
                                                    </div>
                                                    <div class="single-grid mt-24">
                                                        <a class="g-img-sm-1 main-gallary"
                                                            href="{{ asset('assets/images/gallary/gl-5.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/gl-5.png') }}" alt>
                                                        </a>
                                                        <a class="g-img-sm-2 main-gallary"
                                                            href="{{ asset('assets/images/gallary/gl-6.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/gl-6.png') }}" alt>
                                                        </a>
                                                        <a class="g-img-md main-gallary"
                                                            href="{{ asset('assets/images/gallary/g-xxl-3.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/g-xxl-3.png') }}"
                                                                alt>
                                                        </a>
                                                    </div>
                                                    <div class="single-grid mt-24">
                                                        <a class="g-img-sm-1 main-gallary"
                                                            href="{{ asset('assets/images/gallary/gl-17.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/gl-17.png') }}" alt>
                                                        </a>
                                                        <a class="g-img-sm-2 main-gallary"
                                                            href="{{ asset('assets/images/gallary/gl-16.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/gl-16.png') }}" alt>
                                                        </a>
                                                        <a class="g-img-md main-gallary"
                                                            href="{{ asset('assets/images/gallary/g-xxl-4.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/g-xxl-4.png') }}"
                                                                alt>
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                <div class="package-grid-two">
                                                    <div class="single-grid-2">
                                                        <a class="main-gallary"
                                                            href="{{ asset('assets/images/gallary/g-xl-1.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/g-xl-1.png') }}"
                                                                alt>
                                                        </a>
                                                    </div>
                                                    <div class="single-grid-2 mt-24">
                                                        <a class="single-grid-2 main-gallary mt-30"
                                                            href="{{ asset('assets/images/gallary/g-xl-1.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/g-xl-2.png') }}"
                                                                alt>
                                                        </a>
                                                    </div>
                                                    <div class="single-grid-2 mt-24">
                                                        <a class="main-gallary mt-30"
                                                            href="{{ asset('assets/images/gallary/g-xl-1.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/g-xl-3.png') }}"
                                                                alt>
                                                        </a>
                                                    </div>
                                                    <div class="single-grid-2 mt-24">
                                                        <a class="main-gallary mt-30"
                                                            href="{{ asset('assets/images/gallary/g-xl-1.png') }}">
                                                            <img src="{{ asset('assets/images/gallary/g-xl-4.png') }}"
                                                                alt>
                                                        </a>
                                                    </div>
                                                </div>
    ...
    <option value="2">Travel With Plane</option>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="calendar-input">
                                                    <input type="text" name="check-in" class="input-field check-in"
                                            ...
                                            <div class="col-lg-12">
                                                <button class='total' type="text"
                                                    value="Total:$80">Total:$80</button>
